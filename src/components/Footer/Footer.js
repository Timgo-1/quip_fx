...
import { FooterColumn, FooterRow, FooterSection, FtIcon, IconRow, Link } from './FooterStyles';
			...
			<Container>
				<FooterRow>
					<FooterColumn>
						...
						<Text color="#b388ff" maxWidth="360px" size="0.9rem">
							Quip~Fx is an initiative of Greater Tomorrow Investment, Ontario, to which
