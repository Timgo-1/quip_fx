...
const Hero = () => {
	const [sellCur, setSellCur] = useState('CAD');
	...
	return (
		<HeroSection id="hero">
			<Container>
				<Row justify="center">
					<LeftColumn color="violet" width="50%">
						...
						<Text fontSize="0.9" space>
							Transfer money or spend around the world <br />
							cheaper and faster than the orthodox way,<br />
							and receive money anywhere for free.
						</Text>
						<Video
							width="70%"
							src="/videos/Hero.mov"
									...
									<span className="rate">
										...
										>
											<IconContext.Provider
												value={{ size: '1.7rem', color: 'lawngreen' }}
											>
												<AiOutlineRise />
											</IconContext.Provider>
										</motion.span>
