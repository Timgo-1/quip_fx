...
export const Section = styled.section`
	...
	background: ${({ white }) => 
	(white ? 'radial-gradient(circle, rgba(10,43,9,1) 6%, rgba(68,57,89,1) 48%, rgba(132,134,25,1) 100%)'
	: 'radial-gradient(circle, rgba(10,43,9,1) 6%, rgba(68,57,89,1) 48%, rgba(132,134,25,1) 100%)')};
...
export const MainHeading = styled.h1`
	...
	margin-bottom: 2rem;
	color: ${({ inverse }) => (inverse ? '#403ae3' : '#76ff03')};
	width: 100%;
	letter-spacing: 4px;
	text-align: center;
`;
...
export const Heading = styled.h2`
	...
	margin-bottom: ${({ mb }) => (mb ? mb : '')};
	margin-top: ${({ mt }) => (mt ? mt : '')};
	color: ${({ inverse }) => (inverse ? 'aqua' : 'aqua')};
...
export const Text = styled.span`
	...
	min-height: ${({ minHeight }) => (minHeight ? minHeight : '')};
	color: ${({ color }) => (color ? color : '')};
	color: ${({ inverse }) => (inverse ? 'skyblue' : 'skyblue')};
`;
